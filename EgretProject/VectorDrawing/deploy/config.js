module.exports = {
  projectName: '线段工具', // 项目名称
  pages: [// 生成的页面,数组是为了兼容多页项目的情况
    {
      html: 'index.html',
      name: '线段工具',
      key: 'vector-drawing', // 会作为全app展示页配置文件中的key值,需要唯一
    }
  ],
  ...
  distDir: '../bin-release', // 要上传的目录
  ossDir: 'vector-drawing', // 传到oss的目录,存在会覆盖,不存在会自动生成,请保持和git项目一致,避免重复!
